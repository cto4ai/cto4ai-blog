...
I had to watch this part of the talk about five times, first to figure out how you even get to NBP (A: from Agent Manager, just ask for something visual).

But secondly, to grok NBP's big win for development. I've spent a lot of time using Nano Banana Pro, and have been repeatedly amazed at what it can do. But I hadn't connected Dot A---NBP's incredible image generating power---to Dot B---visual designs for the things we're building. It's the design, silly!
...
<SingleImage src="hou_mockup_with_comment.png" alt="NBP mockup with Figma-style comment" size="2xl" postDir="kevin-hou-antigravity" />
