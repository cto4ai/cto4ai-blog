...
This [post from Simon Willison](https://simonwillison.net/2025/Nov/6/async-code-research/) hit my radar yesterday morning and it struck a chord with me. AI coding tools are a research sweet spot for me--that is, I try very hard to stay up--and I've been working the new cloud-based tools from OpenAI and Anthropic into my workflows as much as possible.
...
Anthropic has invested heavily in the AI coding space. Its langauge models surprised many of us by jumping ahead of OpenAI in the coding-model space in June 2024 with Claude 3.5 Sonnet. And they stayed there, progressing rapidly through 3.7, 4, and most recently Sonnet 4.5 just over a month ago. I have used Anthropic coding models almost exclusively since 3.5 Sonnet arrived.
