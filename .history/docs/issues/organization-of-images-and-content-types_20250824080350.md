...
- That contentType property would enable special behaviors when content is rendered (such as we have with Elsewhere content and in our placeholder images in content lists). We have the opportunity to use better names for contentTypes as we set this up
...
- SingleImage and ImageGallery would default to looking for images in the /assets/images/posts
