...
tags: ["Observable", "data visualization", "dashboards", "frameworks"]
...
<img src="/images/blog/observable-framework-blazing-fast/observable_6.webp" alt="Observable Framework" className="w-full max-w-4xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/observable_2.webp" alt="Observable Framework Architecture" className="w-full max-w-3xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/observable_10.webp" alt="Data Last Mile Problem" className="w-full max-w-4xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/observable_7.webp" alt="Framework Benefits" className="w-full max-w-4xl mx-auto" />
...
> **Shell Script Data Loader Example**
>
> Does loading data with a shell script sound crazy? You might be surprised. Here's a one-line Data Loader shell script that downloads recent earthquakes from the USGS in GeoJSON format:
>
> ```bash
...
<video controls width="60%" preload="metadata" loop className="mx-auto">
  <source src="/images/blog/observable-framework-blazing-fast/static_gen_dynamic_dash.mp4" type="video/mp4" />
...
<img src="/images/blog/observable-framework-blazing-fast/data_loader_tip1.png" alt="Data Loader Tip 1" className="w-full max-w-4xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/data_loader_tip2.png" alt="Data Loader Tip 2" className="w-full max-w-4xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/observable_5.webp" alt="Markdown Extensions" className="w-full max-w-4xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/observable_8.webp" alt="JavaScript Runtime" className="w-full max-w-4xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/file_attachment_formats.png" alt="FileAttachment Formats" className="w-full max-w-3xl mx-auto" />
...
<img src="/images/blog/observable-framework-blazing-fast/observable_9.webp" alt="Client-side SQL" className="w-full max-w-4xl mx-auto" />
...
<video controls width="75%" preload="metadata" loop className="mx-auto">
  <source src="/images/blog/observable-framework-blazing-fast/interactive_histogram.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<video controls width="75%" preload="metadata" loop className="mx-auto">
  <source src="/images/blog/observable-framework-blazing-fast/interactive_mortgage_rates.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <img src="/images/blog/observable-framework-blazing-fast/plot_gallery.png" alt="Observable Plot Gallery" className="w-full max-w-3xl mx-auto" />
  <img src="/images/blog/observable-framework-blazing-fast/d3_gallery.png" alt="D3 Gallery" className="w-full max-w-3xl mx-auto" />
</div>
...
<video controls width="50%" preload="metadata" loop className="mx-auto">
  <source src="/images/blog/observable-framework-blazing-fast/apache_echarts_sm.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<video controls width="80%" preload="metadata" loop className="mx-auto">
  <source src="/images/blog/observable-framework-blazing-fast/dashboards_as_code.webm" type="video/webm" />
  Your browser does not support the video tag.
</video>