...
Achieving an all new look on the new standalone blog meant choosing a new Hugo theme, and then migrating all my content, plus my theme-specific customizations in the form of Hugo shortcodes and templates written with Golang templating, to the new theme. On top of the unresolved breaking change, this meant I was facing a rather unpleasant chunk of Hugo work. 
...
As Simon Willison and others have pointed out, having a great language model backing you up takes a lot of the fear out of tackling a challenging project, and that statement was made like 18 months ago---the power of tools like Cursor and Claude Code today 
