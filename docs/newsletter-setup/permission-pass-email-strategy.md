# Permission Pass Email Strategy: Assume Yes vs Assume No

From Jack's Claude https://claude.ai/share/6b49cab5-851b-422b-8788-451a86b6fedd

## The Question

When sending permission pass emails to seed a newsletter list from existing contacts, there are two approaches:

1. **"Assume Yes"** - Email includes "click to unsubscribe" and no action means "you confirm your subscription"
2. **"Assume No"** - Email includes "click to subscribe" and no action means the person stays a non-subscriber

Which approach should be used for launching the CTO4.AI newsletter?
...
- **Quality concerns** - List includes unengaged people who dilute metrics
...
- **Stronger relationships** - People who opt in actually want your content
...
- **Feels like starting over** - Despite existing relationships

---

## Recommendation: Modified "Assume No"

### Legal Reality Check

- **GDPR (EU)**: Requires explicit opt-in. Period.
- **CASL (Canada)**: Requires express consent for newsletters
...
### The Smart Middle Path: "Soft Assume No"

Structure your permission pass with clear opt-in but warm messaging:
...
1. **Legal protection** - Clear opt-in required
2. **Relationship preserved** - Respectful, not presumptuous
3. **Quality over quantity** - 100 engaged subscribers > 500 ghosts
4. **Room to grow** - Can always do more outreach later
...
- Become clients or partners

Those are the subscribers worth having.
...
- **Permission Pass Open Rate**: Target 40-50%
- **Click-to-Subscribe Rate**: Target 10-15% of recipients
- **Unsubscribe Rate Week 1**: Should be <2% if list quality is good
- **Open Rate First Newsletter**: Should be >40% with confirmed opt-in
- **Complaint Rate**: Must stay below 0.1% for deliverability