...
In this case, I'll show you my example instead of Hou's. My initial Antigravity project involves ejecting a project from the Bolt.new platform so we can regain control over the development process, which has proven to be out-of-control unstable with Bolt. The webapp in question is a simple secure data sharing tool, and I worked with Antigravity through the . I didn't actually intend to redo the UI, but since, here I was, in this project, in Agent Manager, I tiny-prompted "generate a new UI look and feel for me to consider for this app" and, one-shot, got this:
...
No implied endorsement of what the model descrives as a "Dark Glassmorphism Theme," but still, this is an not-far-from-viable as a first design iteration, _from a 14-word prompt_. And cool gets even cooler---note that I selected a region of the image and added a comment. Hou:
...
_Dynamic_ representations of information specific to you and your use case.

They help the agent:

- Maintain focus
- Clearly communicate to the user, other agents, subagents
