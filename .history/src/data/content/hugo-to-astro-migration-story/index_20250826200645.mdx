...
Claude is tireless, and that's pretty great on not-fun tasks like migrating Hugo-flavored Markdown to Astro's Markdown + JSX (.mdx) format. With the quantity of content I was migrating, about 100 posts or so, Claude was often on the boundary of "should I write a Python script for this?" versus "I'll just do this myself," which was an interesting model-decision-making process to see happen. Claude was also often at the boundary of being able to keep all the threads in its mind (context) at once---one of my main jobs was reeling Claude in when it lost its way. The dreaded "0% context left until auto-compact" always seems to come at a bad time, and Claude Code does often lose its way post-compact. Not a perfect tool, yet.
