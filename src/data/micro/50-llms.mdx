...
I've been intending to get my feet wet with the [new Claude models](https://www.anthropic.com/news/claude-3-family) from Anthropic, especially Opus. When I saw Simon's [recent "sidequests" post](/elsewhere/two-from-willison/) I decided to update to the latest version of his [LLM CLI tool](https://llm.datasette.io/en/stable/) (part of [Datasette](https://datasette.io/)) and get Opus access from the command line, using the Claude plugin.
