...
_(Note: See [this update](/p/really-openai-update) for a possible workaround._)
...
So sure, _technically_ you _can_ preserve privacy. All you have to do is turn off a feature which I'd argue is ChatGPT+'s most valuable addition to basic chatting. Here's the Settings dialog:
...
<SingleImage
  src="chatgptplus-data-controls-faq.png"
  alt="Chatgptplus Data Controls Faq"
  size="2xl"
  postDir="really-openai"
/>
...
<ImageGallery
  images={['weasel-words.png', 'weasel-words.png', 'weasel-words.png', 'weasel-words.png']}
