...
- Mood: Trustworthy, secure, professional, yet easy to use.
```
...
Hou drifts here, as a relatively new Google hire, into making claims and guarantees that run counter to Google's actual behavior in the past. What Hou says Google will do, is perhaps what they _should do_, but have often _failed to do_.
