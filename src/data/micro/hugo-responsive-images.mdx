...
- ChatGPT (GPT-4 model) continues to be incredibly powerful as [my pair programmer](/blog/unlimited-stupid-questions/). For example, when I needed to really understand why my `picture` output wasn't doing what it should, it gave very accurate guidance. I'd guess that my speed was at least doubled on this little project.
