...
Anthropic has invested heavily in the AI coding space. Its langauge models surprised many of us by jumping into the coding-model lead in June 2024 with the release of Claude 3.5 Sonnet. Again earlier this year, Anthropic took another leap ahead with its minimalist coding agent Claude Code. I used Anthropic coding models almost exclusively since 3.5 Sonnet arrived. Then not long after Claude Code arrived, it supplanted Cursor as my primary AI coding interface. way fI shifted from using Cursor as my main interface to those excellent models, to drive Claude models, to mostly using shifted my coding (research preview February 2025, GA May 2025), with a minimalist command-line interface that stole me (mostly) away from old friend Cursor. I respected OpenAI and ChatGPT for their strength with consumers and the robustness of their APIs and inference services, but coding belonged to Anthropic.
