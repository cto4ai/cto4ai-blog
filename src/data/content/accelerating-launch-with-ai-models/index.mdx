...
<SingleImage
  src="intricate_mosaic@0.5x.webp"
  alt="(Midjourney) Mosaic from a minimal prompt - a very intricate mosaic, bright colors"
  postDir="accelerating-launch-with-ai-models"
  size="xl"
/>
...
<SingleImage
  src="davinci-sub.webp"
  alt="(Midjourney) This one surprised John Berry - leonardo davinci schematic of nuclear attack sub"
  size="2xl"
  postDir="accelerating-launch-with-ai-models"
/>
...
<ImageGallery
  images={['fox2-fox-icon.webp', 'crafty-logo-runner-up-fox-only.webp']}
...
<SingleImage
  src="dreamscape.webp"
  alt="(Midjourney) Dreamscape - dreamscape young red haired girl having dream with cute black bunnies"
  size="2xl"
  postDir="accelerating-launch-with-ai-models"
/>
...
<SingleImage
  src="fractional4.webp"
  alt="(Midjourney) Fractional - stylized representation of fractional fractions slicing"
  size="xl"
  postDir="accelerating-launch-with-ai-models"
/>

<SingleImage
  src="clockslice11lg.webp"
  alt="(Midjourney) Clock face time slices - clock face consisting of separate wedge shapes that represent slices of time"
  size="xl"
  postDir="accelerating-launch-with-ai-models"
/>

<SingleImage
  src="foxmedallion3.webp"
  alt="(Midjourney) Fox medallion - beautiful ornamental circular medallion of a wise crafty fox, realistic eyes, face, muzzle, intricate and detailed, glossy, finely etched silver with gold inlay"
  size="xl"
  postDir="accelerating-launch-with-ai-models"
/>

<SingleImage
  src="diffusionbeemedallion@0.5x.webp"
  alt="(DiffusionBee) Another fox medallion - wise fox in a beautiful round ornamental medallion, realistic eyes, face, muzzle, ears, mainly made of silver with gold inlay, a few gemstones, amber, blue diamond, sapphire, intricately etched, Etching, Detailed and Intricate, extremely fine etching"
  size="xl"
  postDir="accelerating-launch-with-ai-models"
/>

<SingleImage
  src="dall-e2-rabbit.webp"
  alt="(DALL-E 2) Black rabbit - Rabbit with black fur by Frida Kahlo"
  size="xl"
  postDir="accelerating-launch-with-ai-models"
/>
...
<SingleImage
  src="futuristic_spaceship_launching.webp"
  alt="(Midjourney) Launch imagery for blog - futuristic spaceship launching hyper realistic 35mm technicolor"
  size="2xl"
  postDir="blog"
/>
...
<ImageGallery
  images={['clockslice7.webp', 'clockslice8.webp', 'clockslice12.webp', 'clockslice3.webp', 'clockslice10.webp']}
  alt="Gallery of 5 images"
  size="2xs"
  postDir="accelerating-launch-with-ai-models"
/>
