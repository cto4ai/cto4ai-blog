...
image: "~/assets/images/content/hugo-to-astro-migration-story/cto4ai.png"
draft: true
...
The project really wasn't about [Hugo](https://gohugo.io) => [Astro](https://astro.build) at all. Rather, it was about splitting out my fairly substantial, mostly-AI-themed blog from its home as a branch of my corporate site (craftycto.com/blog), to an all-new domain (cto4.ai), while at the same time setting up full-strength email newsletter capabilities.
...
<h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">📊 CraftyCTO.com/blog to cto4.AI  Migration Report</h2>
...
| **Theme** | Custom | [AstroWind](https://github.com/onwidget/astrowind) (heavily modified) |
...
Key developments:
- Newsletter integration with [Beehiiv](https://beehiiv.com) platform
- [Attio](https://attio.com) CRM integration for subscriber management
...
- Newsletter integration with [Beehiiv](https://beehiiv.com)
- CRM integration with [Attio](https://attio.com)
...
3. **Search**: Continued use of [Pagefind](https://pagefind.app) (same as CraftyCTO)
4. **Typography**: Consistent `prose-lg` sizing vs responsive scaling

### Feature Additions
- Newsletter modal with [Beehiiv](https://beehiiv.com) integration
- CRM integration with [Attio](https://attio.com)
...
The cto4ai-blog repository inherits ~950 commits from the [AstroWind](https://github.com/onwidget/astrowind) template project (2022-2025), providing:
