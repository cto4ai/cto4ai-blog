...
He identifies Google's extensive research into computer use, in particular browser use, as a critical element Antigravity takes advantage of:
...
But secondly, to get my head around NBP's big win for development. I've spent a lot of time using Nano Banana Pro, and have been repeatedly amazed at what it can do. But I hadn't connected Dot A---NBP's incredible image generating power---to Dot B---visual designs for the things we're building. It's the design, silly!
...
Here, let me show you my image instead of Hou's. My initial Antigravity project involves ejecting a project from the Bolt.new platform so we can reclaim control over the development process, which has proven to be highly unstable using Bolt. The webapp in question is a simple private data sharing tool that support of , a little partner-network file exchange webapp out of and into something more vanilla that we actually have control over. I didn't actually intend to redo the UI, but since, here I was, in this project, in Agent Manager, I tiny-prompted "generate a new UI look and feel for me to consider for this app" and, one-shot, got this:
...
No implied endorsement of what the model descrives as a "Dark Glassmorphism Theme," but still, this is an actually-viable first design iteration, _from 14 words_. And cool gets even cooler---note that I selected a region of the image and added a comment. Hou:
