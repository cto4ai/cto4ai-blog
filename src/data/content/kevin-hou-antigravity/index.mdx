...
Google DeepMind has definitely gotten my attention with significant releases over the past few weeks, in particular Gemini Pro 3, Gemini 3 Pro Image aka Nano Banana Pro, and most recently Antigravity. Based on [this talk](https://www.youtube.com/watch?v=xmbSQz-PNMM&t=29388s) by Kevin Hou at the recent [AI Engineer Code Summit](https://www.ai.engineer/code), as well ThursdAI's podcast recorded at the same event, I've made it a priority to get hands-on with Antigravity, and find it to be a new and different take on the coding-with-AI experience. If, with Claude Code, Anthropic's message was:
