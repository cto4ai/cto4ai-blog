...
{{< hugo-video src="static_gen_dynamic_dash" autoplay="true" loop="true" width="60%" controls="false">}}
...
{{< hugo-video src="interactive_histogram.mp4" autoplay="true" loop="true" width="75%" controls="false" >}}
...
{{< hugo-video src="interactive_mortgage_rates.mp4" autoplay="true" loop="true" width="75%" controls="false">}}
...
{{< hugo-video src="apache_echarts_sm" autoplay="true" controls="false" loop="true" width="50%" >}}
...
{{< hugo-video src="dashboards_as_code" autoplay="true" controls="false" loop="true" width="80%" >}}