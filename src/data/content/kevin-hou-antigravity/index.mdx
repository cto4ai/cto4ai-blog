...
Those comments feed right back to the Agent Manager, which is then fully capable of _building what Nano Banana designs_. The resulting application likely has a much better design, and is far more robust and maintainable, than anything a prompt-to-app tool like Bolt could produce.
