...
My next step was actually to implement a Python CV solution using the typical toolchain. This immediately exposed a world of hurt with no clear escape; our use case wasn't 100,000 forms of the exact same size and shape, and My partner on the project suggested we check out Amazon Textract. I was skeptical, of course, but AWS has a nice UI for quickly testing Textract, and it didn't take long to be won over, as form after form came through with perfect checkmark detection and selected cell identification.
