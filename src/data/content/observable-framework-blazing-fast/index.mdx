...
draft: false
image: '~/assets/images/content/observable-framework-blazing-fast/observable_1.webp'
---
...
<SingleImage
  src="observable_6.webp"
  alt="Observable Framework"
  size="2xl"
  postDir="observable-framework-blazing-fast"
/>
...
<SingleImage
  src="observable_7.webp"
  alt="Observable Framework Benefits"
  size="2xl"
  postDir="observable-framework-blazing-fast"
/>
...
Well, guess what: those same Data Loaders whose elegant separation of concerns simplify the gathering of data for dynamic dashboards and reports, also solve the slow data problem. Data Loaders do the time-consuming work of querying and collecting data at **_build time_**. At **_runtime_**, the data is already **_pre-generated, cached, and ready to access in milliseconds_**. So thanks to static generation and Data Loaders, Framework is able to deliver a near-instantaneous interactive experience _for data_.
...
<SingleImage
  src="data_loader_tip1.png"
  alt="Data Loader Tip 1"
  size="2xl"
  postDir="observable-framework-blazing-fast"
/>
...
<SingleImage
  src="data_loader_tip2.png"
  alt="Data Loader Tip 2"
  size="2xl"
  postDir="observable-framework-blazing-fast"
/>
...
<SingleImage
  src="observable_5.webp"
  alt="Framework Notebook Features"
  size="2xl"
  postDir="observable-framework-blazing-fast"
/>
...
<SingleImage
  src="file_attachment_formats.png"
  alt="FileAttachment Supported Formats"
  size="xl"
  postDir="observable-framework-blazing-fast"
/>
...
<SingleImage
  src="observable_9.webp"
  alt="Client-side SQL Benefits"
  size="2xl"
  postDir="observable-framework-blazing-fast"
/>
...
<video autoplay muted loop width="80%" style="max-width: 100%">
  <source src="/videos/dashboards_as_code.webm" type="video/webm" />
</video>
