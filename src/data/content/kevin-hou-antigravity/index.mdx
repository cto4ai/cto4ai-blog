...
Those comments feed right back to the Agent Manager, which is fully capable of _building what Nano Banana designs_ ---especially with this commenting capability. The resuls is an application that has a better design, and is far more robust and maintainable, than anything from a prompt-to-app tool like Bolt.
