...
<SingleImage
  src="James-Herriot-All-Creatures-Great-and-Small.jpg"
  alt="The book and the man"
  postDir="a-day-to-remember"
  size="lg"
/>
...
<SingleImage
  src="cooperage-bottom-bg.jpg"
  alt="Theakstons, makers of Old Peculier, are proud of their custom-made casks"
  postDir="a-day-to-remember"
  size="lg"
/>
...
<SingleImage
  src="sutton_bank.jpg"
  alt="Warning sign for Sutton Bank grade on the A170"
  postDir="a-day-to-remember"
  size="lg"
/>
...
<SingleImage
  src="yorkshire-gliding-club.jpg"
  alt="Sign for the Yorkshire Gliding Club. If memory serves, the sign was different in 1987. © Copyright Pauline E and licensed for reuse under the Creative Commons License"
  postDir="a-day-to-remember"
  size="lg"
/>
...
<SingleImage
  src="2021-05-04-20-04-0015.jpeg"
  alt="Found a photo of this actual flight! ASK-21 tail number ESB on landing."
  postDir="a-day-to-remember"
  size="lg"
/>
...
<SingleImage
  src="ask21-inst-panel.jpg"
  alt="Vintage ASK-21 instrument panel. Mine would have had a few additional (IFR) instruments."
  postDir="a-day-to-remember"
  size="lg"
/>
...
<SingleImage
  src="ASK-21-Aerobatics.png"
  alt="ASK-21 aerobatics including the Stall Turn, from ASK-21 Flight Manual"
  postDir="a-day-to-remember"
  size="lg"
/>
...
<SingleImage
  src="drunken_grilled_cheese_sandwich_on_cutting_board.jpg"
  alt="Grilled Cheese & Onion. Photo from http://ohmyveggies.com/"
  postDir="a-day-to-remember"
  size="lg"
/>
