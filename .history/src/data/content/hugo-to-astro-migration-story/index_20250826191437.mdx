...
This wasn't my first Claude Code deep dive, but it was definitely the deepest---something that became clear as I upgraded from pay-per-token Anthropic API use to Claude Max $100 and finally to Claude Max $200.

The project really wasn't about Hugo => Astro at all. Rather, it was about splitting out my fairly substantial, mostly-AI-themed blog from its location as a branch of my corporate site (craftycto.com/blog), to an all-new domain (cto4.ai), and at the same time setting up full-strength email newsletter capabilities. 

Why leave Hugo, which has served me well since 2022? The Hugo project made a breaking change sometime in 2024, during a multi-month lull in my writing; when I came back to restart publishing, I figured I'd upgrade to latest Hugo version, and kaboom---the build was broken. Even with LLM help and quite a few hours of research, no joy; so I downgraded to the last release before the breaking change, losing some of my Hugo love in the process. 

Achieving an all new look on the new standalone blog meant choosing a new Hugo theme, and then migrating all my content, and my theme-specific customizations in the form of Hugo shortcodes and templates, to the new theme. On top of the unresolved breaking change, this meant I was facing a rather unpleasant chunk of Hugo work. 

I had been keeping tabs on other static site generators, with Astro coming up a lot as best/most modern, and I realized it might not be that much more work to build the new site on Astro ... 
...
In August 2025, I embarked on an ambitious project: migrating my blog from its long-standing Hugo-based home within the CraftyCTO corporate site to a standalone, modern Astro-powered platform at CTO4.AI. What started as a typical web migration quickly evolved into something far more interesting—a case study in effective human-AI collaboration.

The numbers tell a compelling story: 84% of the migration commits came from Claude Code, while I contributed just 16%. Yet those human commits accounted for 37.4% of the code additions, revealing a fascinating partnership pattern. This wasn't AI replacing human work; it was AI amplifying human direction.

## The Migration Challenge

The CraftyCTO blog had served me well since 2022, running on Hugo with its blazing-fast build times and excellent performance scores. But as my content strategy evolved, I needed more flexibility. I wanted MDX support for interactive components, better newsletter integration, and a clean separation between blog and corporate presence.

The technical requirements were substantial: migrate dozens of posts with their images, implement newsletter and CRM integrations, maintain SEO and performance standards, and ensure zero downtime during the transition. Doing this alone would have taken weeks. With Claude Code, we accomplished it in days.

## The Human-AI Partnership

What emerged was a natural division of labor. My commits were brief—often single words like "reorg" or "linking"—but they represented strategic decisions and structural changes. Claude Code's commits were detailed and technical, handling the implementation minutiae with descriptive messages like "Fix newsletter modal form submission" and "Add Attio CRM integration for newsletter subscribers."

This wasn't about delegation; it was about collaboration. I'd make a quick structural change, and Claude Code would flesh out the details. I'd identify a need, and Claude Code would implement the solution. The AI handled 68 commits with focused, incremental improvements, while my 13 commits provided the architectural vision.

## Key Technical Achievements

The migration brought significant improvements:

- **Modern Stack**: Moved from Hugo to Astro v5.13 with full MDX support
- **Enhanced Features**: Added newsletter integration with Beehiiv, CRM connectivity with Attio, and maintained Pagefind search
- **Performance**: Achieved 96 PageSpeed score (vs 98 on Hugo)—a negligible difference for massive gains in flexibility
- **Developer Experience**: TypeScript, Tailwind CSS, and component-based architecture

The most impressive aspect? Complex features like API endpoints via Cloudflare Functions and real-time newsletter subscriptions were implemented in single sessions, with Claude Code handling the technical complexity while I focused on requirements and testing.

## Lessons in AI Collaboration

This project taught me that effective AI collaboration isn't about maximizing AI output—it's about optimizing the human-AI interface. My terse commit messages weren't laziness; they were efficient communication. When I committed "ng wip" (Angular work in progress), Claude Code understood the context and expanded on the foundation.

The 84/16 commit split might suggest AI dominance, but the 62.6/37.4 code addition ratio tells the real story: humans excel at big-picture changes, while AI excels at detailed implementation. Together, we achieved what neither could efficiently accomplish alone.

## Looking Forward

The migration is complete, the blog is live at CTO4.AI, and the performance metrics are excellent. But more importantly, this project demonstrated a new development paradigm—one where human creativity and AI capability combine to compress timelines without sacrificing quality.

As we enter an era where AI tools become increasingly capable, the question isn't whether to use them, but how to use them effectively. This migration shows that the answer lies not in replacement but in partnership, where brief human guidance can unlock tremendous AI productivity.

---

## Claude Code Project Deep Dive Report

<div className="mt-8 space-y-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg p-6 bg-gray-50 dark:bg-gray-900">

<h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">📊 CraftyCTO to CTO4.AI Blog Migration Report</h2>
...
<details className="group">
<summary className="cursor-pointer list-none flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
<span className="font-semibold text-lg">📅 Repository Timeline</span>
<span className="text-gray-500 group-open:rotate-90 transition-transform">▶</span>
</summary>
<div className="mt-3 ml-4 pl-4 border-l-4 border-primary/30 prose prose-lg dark:prose-invert max-w-none">
...
<details className="group">
<summary className="cursor-pointer list-none flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
<span className="font-semibold text-lg">🔧 Technology Stack Comparison</span>
<span className="text-gray-500 group-open:rotate-90 transition-transform">▶</span>
</summary>
<div className="mt-3 ml-4 pl-4 border-l-4 border-primary/30 prose prose-lg dark:prose-invert max-w-none">
...
<details className="group">
<summary className="cursor-pointer list-none flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
<span className="font-semibold text-lg">📈 Migration Phases</span>
<span className="text-gray-500 group-open:rotate-90 transition-transform">▶</span>
</summary>
<div className="mt-3 ml-4 pl-4 border-l-4 border-primary/30 prose prose-lg dark:prose-invert max-w-none">
...
<details className="group">
<summary className="cursor-pointer list-none flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
<span className="font-semibold text-lg">🤖 Claude Code Contributions</span>
<span className="text-gray-500 group-open:rotate-90 transition-transform">▶</span>
</summary>
<div className="mt-3 ml-4 pl-4 border-l-4 border-primary/30 prose prose-lg dark:prose-invert max-w-none">
...
<details className="group">
<summary className="cursor-pointer list-none flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
<span className="font-semibold text-lg">📊 Code Statistics</span>
<span className="text-gray-500 group-open:rotate-90 transition-transform">▶</span>
</summary>
<div className="mt-3 ml-4 pl-4 border-l-4 border-primary/30 prose prose-lg dark:prose-invert max-w-none">

### Your Migration Work Only
...
<details className="group">
<summary className="cursor-pointer list-none flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
<span className="font-semibold text-lg">🎯 Key Migration Decisions</span>
<span className="text-gray-500 group-open:rotate-90 transition-transform">▶</span>
</summary>
<div className="mt-3 ml-4 pl-4 border-l-4 border-primary/30 prose prose-lg dark:prose-invert max-w-none">
...
<details className="group">
<summary className="cursor-pointer list-none flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
<span className="font-semibold text-lg">⚠️ Technical Debt & Considerations</span>
<span className="text-gray-500 group-open:rotate-90 transition-transform">▶</span>
</summary>
<div className="mt-3 ml-4 pl-4 border-l-4 border-primary/30 prose prose-lg dark:prose-invert max-w-none">
