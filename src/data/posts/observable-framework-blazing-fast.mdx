...
<SingleImage src="observable_2.webp" alt="Observable Framework Architecture" size="xl" postDir="observable-framework-blazing-fast" />
...
<SingleImage src="observable_10.webp" alt="Data Last Mile Problem" size="2xl" postDir="observable-framework-blazing-fast" />
...
<SingleImage src="observable_7.webp" alt="Framework Benefits" size="2xl" postDir="observable-framework-blazing-fast" />
...
<SingleImage src="observable_5.webp" alt="Markdown Extensions" size="2xl" postDir="observable-framework-blazing-fast" />
...
<SingleImage src="file_attachment_formats.png" alt="FileAttachment Formats" size="xl" postDir="observable-framework-blazing-fast" />
...
<SingleImage src="observable_9.webp" alt="Client-side SQL" size="2xl" postDir="observable-framework-blazing-fast" />
...
<ImageGallery images={['plot_gallery.png', 'd3_gallery.png']} alt="Observable Plot and D3 Galleries" size="xl" postDir="observable-framework-blazing-fast" />
