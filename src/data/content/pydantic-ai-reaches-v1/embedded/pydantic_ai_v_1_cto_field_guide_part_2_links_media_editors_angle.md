...
- Choose **DSPy** when you want **programmatic pipelines** that _compile_ to better prompts/weights and integrate into your stack for optimization/evals.  
...
- **Software Engineering Radio #676** — _Samuel Colvin on Pydantic & Pydantic AI_ (2025‑07‑10).  
...
- **YouTube (Pydantic channel):** _Pydantic AI — MCP Sampling_ (published ~2 months ago).  
  Link: [Video](https://www.youtube.com/watch?v=3AK7kznOl3k)
- **YouTube (AI Engineer World’s Fair):** _MCP is all you need — Samuel Colvin_ (published ~2–3 months ago).  
