...
- **Production rails**: **Observability** (OTel/Logfire), **Durability** (Temporal/DBOS), **UI protocol** (AG‑UI), **MCP** tooling.  
  Sources: [Logfire](https://ai.pydantic.dev/logfire/), [Durable exec](https://ai.pydantic.dev/durable_execution/overview/), [AG‑UI](https://ai.pydantic.dev/ag-ui/), [MCP](https://ai.pydantic.dev/mcp/)
- **Evaluation & testing**: examples + Pydantic Evals + OTel.  
  Sources: [Examples](https://ai.pydantic.dev/examples/setup/), [Changelog](https://ai.pydantic.dev/changelog/)
...
**Next:** See **Part 2: Links, Media, Editor’s Angle** for references, recent talks, and curated links.
