...
I'm leaning towards a variation of option 2Let me outline it: 

- Front matter in all content mdx and md files would be updated to include a contentType property  of all types. That c
│   - Content itself would be stored under a single /src/data/xxx/{postDir} where xxx is a content-type-independent name\ 
