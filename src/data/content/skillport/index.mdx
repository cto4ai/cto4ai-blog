...
<SingleImage src="claude_code_plugin_marketplaces.png" alt="Claude Code Plugin Marketplaces announcement" postDir="skillport" size="2xl" />
...
The main gap, to me, was Skill distribution and sharing. I wanted the elegance of Plugin Marketplaces, e.g. git repo based with Skill versioning, but without the public repo constraint and supporting all Claude surfaces. Would it be feasible create a project that extends the Plugin Marketplace concept to support private repos, authentication, and get it working across all Claude surfaces?
