...
```astro
<ImageGallery
  images={['barth_streams_agents.png', 'barth_streams_agents_mcp.png']}
  alt="Gallery of 2 images"
  size="xl"
  postDir="aiewf2025-my-day-1-highlights"
/>
```
...
```astro
import SingleImage from '~/components/ui/SingleImage.astro'; import ImageGallery from
'~/components/ui/ImageGallery.astro';
```
