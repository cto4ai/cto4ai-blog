...
Chroma (the product) is an open-source vector database specifically designed to enhance large language model (LLM) applications. Chroma (the company) was founded in April 2022 by Jeff Huber (CEO) and Anton Troynikov and is headquartered in San Francisco.
