...
Last week, the news cycle[^1] collided with my post on Claude Agent Skills. This week, perhaps I'm having better luck: the lead session of the CODE track at last week's [AI Engineer Code Summit](https://www.ai.engineer/code) was Anthropic's [Barry Zhang](https://www.linkedin.com/in/barry-z/) & [Mahesh Murag](https://www.linkedin.com/in/maheshmurag/) speaking on that exact topic.
...
> A lot of things have changed since our last talk. [MCP](https://modelcontextprotocol.io/) became the standard for agent connectivity. [Claude Code](https://www.anthropic.com/claude-code), our first coding agent, launched to the world, and [Claude Agent SDK](https://docs.claude.com/en/api/agent-sdk/overview), now provides a production-ready agent out of the box.
...
I have been deep enough in this agent world to know the pain points, and this next statement (along with yesterday's release of [Opus 4.5](https://www.anthropic.com/news/claude-opus-4-5) and much more[^2]) gives me hope that Anthropic is contining to march in the right direction:
...
In the partner category, the new skill from [Browserbase](https://www.browserbase.com) gets me very excited, because, "look mom, no MCP!":

> We've also seen partners in the ecosystem build skills that help Claude better with their own software and their own products. Browserbase is a pretty good example of this. They built a skill for their open-source browser automation tooling, [Stagehand](https://www.stagehand.dev/). And now Claude [is] equipped [with] this skill and with Stagehand can now go navigate the web and use a browser more effectively to get work done.
...
Yeah, upon closer inspection, this is definitely not our old [OODA](https://en.wikipedia.org/wiki/OODA_loop) agentic loop. Murag says:
