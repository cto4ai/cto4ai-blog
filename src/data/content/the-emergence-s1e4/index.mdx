...
In any case---I've again passed through another week-long Period of Agonizing, and this is now my fourth AI post. The material doesn't seem to be drying up, so I'm just going to run with it and start using Netflix style season-episode numbering. So _Welcome To S1E4._
...
<SingleImage src="sleep-on-it.webp" alt="Sleep on it" size="2xl" postDir="the-emergence-s1e4" />
...
<SingleImage src="burton-rules-change.webp" alt="Burton Rules Change" size="2xl" postDir="the-emergence-s1e4" />
...
<SingleImage
  src="reddit-midjourney-stockphoto.webp"
  alt="Reddit Midjourney Stock Photo"
  size="2xl"
  postDir="the-emergence-s1e4"
/>
...
<SingleImage src="emergence.webp" alt="Emergence" size="2xl" postDir="the-emergence-s1e4" />
